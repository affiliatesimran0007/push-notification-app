// Simple Push Notification Integration for Vercel Deployment
// Update the PUSH_CONFIG with your Vercel app URL and settings

(function() {
  // Configuration - Update these values after deployment
  const PUSH_CONFIG = {
    appUrl: 'https://your-app.vercel.app', // UPDATE: Your Vercel app URL
